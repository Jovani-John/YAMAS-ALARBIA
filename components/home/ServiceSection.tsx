...
export default function ServicesTabsSection() {
  ...
  const content: Record<string, Content> = {
    ar: {
      ...
      subtitle:
        "اختر الخدمة المناسبة لك واستكشف كيف نقدم حلول مبتكرة لكل مشروع",
      ...
      services: [
        {
          ...
          code: "CBW",
          description:
            "نقدم حلول بناء متكاملة للمشاريع السكنية والتجارية والصناعية بأعلى معايير الجودة العالمية",
          features: [
            {
              title: "الفلل والمجمعات السكنية",
              desc: "تصاميم عصرية تناسب احتياجاتك",
            },
            {
              title: "المباني التجارية والمولات",
              desc: "مشاريع ضخمة بإدارة احترافية",
            },
            { title: "المصانع والمستودعات", desc: "بنية تحتية صناعية قوية" },
            {
              title: "مشاريع البنية التحتية",
              desc: "حلول مبتكرة للمشاريع الكبرى",
            },
          ],
          stats: {
            projects: 33,
        ...
        },
        {
          ...
          features: [
            ...
            {
              title: "الجامعات والمستشفيات",
              desc: "مرافق تعليمية وصحية متطورة",
            },
        ...
        },
        {
          ...
          code: "FW",
          description:
            "تشطيبات داخلية وخارجية بأرقى المواصفات والتصاميم العصرية التي تناسب ذوقك",
          features: [
            ...
            { title: "التكييف المستشفىي", desc: "أنظمة تبريد حديثة" },
          ],
          stats: {
            projects: 33,
            years: 24,
    ...
    en: {
      ...
      subtitle:
        "Choose the right service for you and discover how we deliver innovative solutions for every project",
      ...
      services: [
        {
          ...
          features: [
            ...
            },
            {
              ...
              desc: "Strong industrial infrastructure",
            },
            {
              title: "Infrastructure Projects",
              desc: "Innovative solutions for major projects",
            },
          ],
          stats: {
            projects: 33,
        ...
        },
        {
          ...
          features: [
            ...
            },
            {
              ...
              desc: "Advanced educational and healthcare facilities",
            },
            {
              title: "Airports & Transport Stations",
              desc: "Giant transportation projects",
            },
