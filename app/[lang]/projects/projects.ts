...
const healthcareProjects: YamasProject[] = [
  ...
  // },
  {
    ...
    descriptionEn:
      "Design and construction of One Day Surgery building with 1,500 sqm area",
    scope: [
      "غرف عمليات حديثة",
      "غرف إفاقة",
      "عيادات خارجية",
  ...
  },
  {
    ...
    client: "وزارة الصحة",
    clientEn: "Ministry of Health (MOH)",
    location: " الخبر، المنطقه الشرقية",
    ...
    description:
      "تصميم وإنشاء مستشفى  64 سرير بمساحة 1,250 متر مربع على طابقين",
    descriptionEn:
      "Design and construction of 64-bed Corona Hospital with 1,250 sqm on two floors",
    scope: [
      "64 غرفة عزل",
      "غرفتي عمليات",
      "أنظمة MEP",
  ...
  },
  {
    ...
    description: "تصميم وإنشاء مستشفى  100 سرير بمساحة 1,500 متر مربع",
    descriptionEn:
      "Design and construction of 100-bed Corona Hospital with 1,500 sqm",
    scope: [
      "100 غرفة عزل",
      "4 غرف عمليات",
      "أنظمة MEP",
  ...
  },
  {
    ...
    description:
      "تصميم وإنشاء مستشفى  بطاقة 300 سرير، بمساحة بناء 1,500 متر مربع على أربعة طوابق",
    descriptionEn:
      "Design and construction of 300-bed Corona Hospital, with 1,500 sqm built-up area across four floors",
    scope: [
      "120 غرفة عزل",
      "4 غرف عمليات",
      "100 سرير متخصص",
...
const housingProjects: YamasProject[] = [
  {
    ...
    description: "بناء فلل سكنية على مرحلتين ، ضاحيه",
    descriptionEn:
      " Construction of  residential villas in two phases in Al-Fursan 3 district, Riyadh",
    scope: [
...

  {
    ...
    description:
      "تصميم وإنشاء 439 فيلا فاخرة بدور أرضي وأول وسطح حسب مستوى روشن، بمساحة بناء 153,650 متر مربع",
    descriptionEn:
      "Design and construction of 439 luxury villas with ground, first, and roof floors at Roshen level, 153,650 sqm built-up area",
    scope: [
      "تصميم معماري متميز حسب معايير روشن",
      "تنفيذ البناء والتشطيبات الفاخرة",
      "أعمال MEP متكاملة",
  ...
  },
  {
    ...
    description:
      "تصميم وإنشاء 220 فيلا فاخرة بدور أرضي وأول وسطح حسب معايير ، بمساحة بناء 300,000 متر مربع",
    descriptionEn:
      "Design and construction of 220 luxury villas with ground, first, and roof floors at NHC level, 300,000 sqm built-up area",
    scope: [
      "تصميم معماري حسب معايير ",
...
const commercialProjects: YamasProject[] = [
  ...
  },
  {
    ...
    description:
      "تصميم وإنشاء مول تجاري فاخر على مستوى بودية بمساحة 5,000 متر مربع، يشمل ستريب مول مع هايبر ماركت ومواقف لأكثر من 15,000 مركبة",
    descriptionEn:
  ...
  },
  {
    ...
    mainImage: "",
    images: [],
    description: "تطوير مستشفى صيانة متكامل للسيارات",
...
const towersProjects: YamasProject[] = [
  ...
  description: "تطوير مجمع سكني متكامل الاستخدامات في الرياض، يشمل مباني سكنية وتجارية مع تشطيبات تسليم مفتاح",
  ...
  scope: [
    ...
    "أعمال الكهرباء والميكانيكا والسباكة (MEP)",
    "الأعمال الخارجية وتنسيق الحدائق",
...
},
  {
    ...
    description:
      "مبنى سكني راقي مكون من 15 طابق بمساحة بناء إجمالية 22,295 متر مربع، يشمل 62 شقة سكنية و100 موقف سيارات",
    descriptionEn:
      "Premium residential building of 15 floors with total built-up area of 22,295 sqm, including 62 apartments and 100 parking spaces",
    scope: [
      "62 شقة سكنية فاخرة",
...
const governmentProjects: YamasProject[] = [
  ...
  // },
  {
    ...
    description: "مشروع خيري في الدمام",
