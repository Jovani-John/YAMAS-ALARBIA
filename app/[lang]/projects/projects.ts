...
const housingProjects: YamasProject[] = [
  ...
  },
  {
    ...
    description:
      "تصميم وإنشاء 220 فيلا فاخرة بدور أرضي وأول وسطح حسب معايير الإسكان الوطني، بمساحة بناء 300,000 متر مربع",
    descriptionEn:
...
images: [],
    description:
      "أعمال التشطيب لـ 149 فيلا فاخرة بدور أرضي وأول وسطح حسب مستوى الإسكان الوطني، بمساحة بناء 59,600 متر مربع",
    descriptionEn:
...
const towersProjects: YamasProject[] = [
  ...
  },
  {
    ...
    client: "قطاع خاص",
    clientEn: "Private Sector",
    location: "المنطقة الجنوبية، أبها",
